      ...
      <main className="mx-auto max-w-[1400px] px-4 py-6">
        <div className="mb-5">
          ...
          <p className="mt-2 text-base leading-relaxed text-foreground">
            나는 <span className="rounded-md bg-accent/15 px-2 py-0.5 font-bold text-accent">반대</span>, AI는 <span className="font-semibold text-muted-foreground">찬성</span> 입장입니다. 끝까지 자신의 입장을 견지해 보세요.
          </p>
        </div>
